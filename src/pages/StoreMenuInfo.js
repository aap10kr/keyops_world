...
import Return from "../imgs/Group 8483.png";
import MapLink from "../imgs/mapLink.png";

const StoreInfo = ({ storeNum, fn }) => {
  const info = getStoreMenuInfo[storeNum];
  ...
  return (
    <>
      {iframe && (
        <div
          className="z-50 absolute w-screen h-screen bg-gray-700/70"
          onClick={() => iframenmapClose()}
        >
      ...
      <div className="w-screen min-h-screen relative">
        ...
        >
          <div className="relative w-full h-full bg-black">
            ...
            <div className="w-full h-full flex pb-4 ml-6">
