...
import Select_img from "./imgs/land.png";
...
import Intro from "./imgs/Instruction.png";
import IntroBtn from "./imgs/Frame 8577.png";
...
import 해운대암소갈비 from "./images/해운대 암소갈비.png";
import 초량밀면 from "./images/초량밀면.png";
...
import StoreMenuInfo from "./pages/StoreMenuInfo.js";
...
const App = () => {
  ...
  const [clicMenuknum, setClicMenuknum] = useState(0);
  ...
  const [PlayMenuSection, SetPlayMenuSection] = useState(false);
  ...
  function DicePlay() {
    ...
    if (newCurrentNum > 23) {
      ...
      setClicknum(newCurrentNum - 23);
      playButon(newCurrentNum - 23);
      setButtonscore(false);
      setButtonGroup(false);
    } else if (
      newCurrentNum == 3 ||
  ...
  function RightSection(id) {
    setClicMenuknum(id);
    SetPlayMenuSection(true);
    setIsShowNav(false);
    setHomeButton(false);
    setButtonscore(false);
    setButtonGroup(false);
        ...
        {introduce && (
          <div className="z-50 w-screen h-screen bg-gray-700/70">
            <div className="fixed w-full flex justify-center items-center">
              ...
              >
                <img src={Intro} alt="" className="w-[450px]" />
              </button>
            </div>
          </div>
        )}
        ...
        {isPopupOpen && (
          <div className="z-50 w-screen h-screen bg-gray-700/70">
            <div className="fixed flex bottom-6 right-6">
              ...
              >
                <img src={nextBtn} alt=""  className="w-80"/>
              </button>
            </div>
          </div>
        )}
          ...
          <div className="z-50 w-screen h-screen bg-gray-700/70">
            <div className="fixed flex bottom-6 right-6">
              <button
                ...
                className="relative flex bottom-0 right-0"
              >
                <img src={CloseBtn} alt="" className="w-80"/>
              </button>
            </div>
          </div>
        )}
        {isLoding && <LoadingPage />}
        {playSection && <StoreInfo storeNum={clicknum} fn={HandleButton} couponCount={couponCount}/>}
        {PlayMenuSection && (
          <StoreMenuInfo storeNum={clicMenuknum} fn={HandleButton} />
        )}
      </div>
      <div className="z-30 w-screen h-screen flex justify-center items-center bg-[#9C9C9C] overflow-hidden">
        {buttonScore && (
          <div className="absolute z-20 bottom-4 left-[2rem] w-[92%] flex justify-between items-center">
            <div>
              <button onClick={() => openintroduce()}>
              ...
              >
                <div className="px-2.5 py-0.5 lg:px-14 lg:py-2">
                  <span className="text-xs font-bold tracking-tighter lg:text-xl">
                    Dice Click!
                  </span>
                  <div className="flex justify-center items-center relative top-[-4px]">
                    <div className="text-pink-600 font-bold lg:text-3xl">{playCount}</div>
                    <div className="font-bold px-1.5 lg:text-3xl">/</div>
                    <div className="font-bold lg:text-3xl">8</div>
                  </div>
                </div>
              </button>
            </div>
        ...
        {buttonGroup && (
          <div
            className="absolute z-10 w-[730px]"
            onClick={() => setIsShowNav(false)}
          >
            {currentNum === 1 && (
              <div >
...
import LoadingPage from "./pages/EnLoading";

import Select_img from "./imgs/Enland.png";
import nextBtn from "./imgs/EnNext.png";
import CloseBtn from "./imgs/EnClose.png";
import HomeBtn from "./imgs/return.png";
import GameBtn from "./imgs/userName.png";
import Touch from "./imgs/EnTouch.png";
import Coupon from "./imgs/coupon.png";
import RightBtn from "./imgs/Enmenu.png"
import Boom from "./imgs/EnBoom.png"
import Intro from "./imgs/Enintroduce.png"
import IntroBtn from "./imgs/Group 8817.png"
...
import 깡통시장 from "./images/깡통시장.png";
import 해운대암소갈비 from "./images/해운대 암소갈비.png";
import 부산국밥거리 from "./images/초량밀면.png";
import 솥솥 from "./images/솥솥.png";
import 융캉찌에 from "./images/융캉찌에.png";
import 불란사그로서리 from "./images/불란서그로서리.png";
import 꽝2 from "./images/꽝2.png";
...
import StoreMenuInfo from "./pages/StoreMenuInfo.js";
import EnStoreInfo from "./pages/EnStoreInfo.js";
import EnStoreMenuInfo from "./pages/EnStoreMenuInfo.js";
import Dice from "./components/Dice.js";
import RightNav from "./components/EnRightNav";
  ...
  return (
    <>
      ...
      <div className="absolute w-screen h-screen" onClick={() => setIsShowNav(false)}>
        ...
        {isLoding && <LoadingPage />}
        {playSection && <EnStoreInfo storeNum={clicknum} fn={HandleButton} couponCount={couponCount}/>}
        {PlayMenuSection && <EnStoreMenuInfo storeNum={clicMenuknum} fn={HandleButton}/>}
      </div>
      <div className="z-30 w-screen h-screen flex justify-center items-center bg-[#9C9C9C]">
        ...
        {buttonGroup && (
          <div className="absolute z-10 w-[730px]" onClick={() => setIsShowNav(false)}>
            {currentNum === 1 && (
              <div>
                <img src={해목} alt=""/>
              </div>
